...
namespace agn
{
     ...
     * 
     */
    class SimulationTeamAGNSmooth
    {
    private:
        static constexpr phys_size MAX_NUM_PHOTONS_PER_FILE = 2'000'000; // MAXIMUM NUMBER OF PHOTONS PER FILE
        static const std::string FILE_LABEL;                             // FILE LABEL.
                                                                         //FULL NAME IS: FILE_LABEL + "thread_" + "m_id" + "<i>.txt"
    ...
    public:
        /**
         * @brief Construct a new Simulation Team A G N Smooth object
         * 
         * @param geometry 
         * @param id 
         */
        SimulationTeamAGNSmooth(const PGeometryBase &geometry,
                                phys_float n_e,
                                phys_float T_e,
        ...
        /**
         * @brief Destroy the Simulation Team A G N Smooth object
         * 
         */
        virtual ~SimulationTeamAGNSmooth() {}
    ...
    private:
        const phys_size m_id;            // instance id
        const PGeometryBase &m_geometry; // agn geometric shape
        phys_float m_n_e;                // concentration of electrons
        phys_float m_T_e;                // temperature of electrons
    ...
    private:
        ...
        std::vector<std::array<phys_float, 4>> m_listOfAbsorvingElements;
    ...
    private:
        void movePhotonTointeractionPoint(PSimplePhoton &photon,
                                          phys_float lambdaMean,
                                          phys_float escapeProbability,
                                          phys_float freeLength = 0);
    };
} // namespace agn
